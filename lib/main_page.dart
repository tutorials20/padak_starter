...
class _MainPageState extends State<MainPage> {
  ...
  // 2-1. 선택한 sort 방식에 대한 변수 선언
  int _selectedSortIndex = 0;

  // 2-2. initState() 에서 영화 목록을 가져옵니다.
  @override
  void initState() {
    super.initState();
    _requestMovies();
  ...
  void _requestMovies() async {
    ...
    final response = await http
        .get('http://52.79.87.95:3003/movies?order_type=$_selectedSortIndex');
  ...
  // 2-5. 각 index 에 맞는 제목을 호출해주는 로직 작성
